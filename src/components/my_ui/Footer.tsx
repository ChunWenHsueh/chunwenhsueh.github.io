...
function Footer() {
  return (
    <footer className="flex w-full items-center justify-between space-x-2 bg-[#f2f3f4] p-4 dark:bg-neutral-800">
      ...
      <div>
        <p>Copyright © 2024 Chun-Wen Hsueh. All Rights Reserved.</p>
      </div>
    </footer>
  );
}
